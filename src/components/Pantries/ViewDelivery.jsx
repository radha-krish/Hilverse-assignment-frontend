...
const ViewPantryStaff = () => {
  ...
  useEffect(() => {
    ...
    const fetchStaffMembers = async () => {
      try {
        const response = await fetch(API_URLS.getDelivery, {
          method: "GET",
          headers: {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-gray-50">
      <h2 className="text-3xl font-bold text-teal-700 mb-8"> Delivery Staff Members</h2>
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-800 text-sm">{staff.email}</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium text-gray-600">Contact Info:</span>
                  <span className="text-gray-800 text-sm">{staff.contactInfo}</span>
                </div>
                <div className="flex justify-between">
