  ...
  const handleFilter = async () => {
    try {
      ...
      const response = await fetch(API_URLS.getOrdersByFilters, {
        ...
        body: JSON.stringify({ inputDate, pantryId: "pantry" }), // Send the date to the backend
      });
  ...
  const handleMakeInProgress = async () => {
    try {
      ...
      const response = await fetch(API_URLS.updateOrdersStatusAndDeliveryStatus, {
        ...
        body: JSON.stringify({ orderIds: selectedOrders, orderStatus: "preparing" }),
      });
  ...
  const handleMakeComplete = async () => {
    try {
      ...
      const response = await fetch(API_URLS.updateOrdersStatusAndDeliveryStatus, {
        ...
        body: JSON.stringify({ orderIds: selectedOrders, orderStatus: "completed" }),
      });
